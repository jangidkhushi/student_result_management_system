...
class StudentClass:
    def __init__(self,root):
        ...
        #title
        title=Label(self.root,text="Student Record",font=("goudy old style",20,"bold"),bg="#033054",fg="white").place(x=10,y=15,width=1180)
        ...
        lbl_city=Label(self.root,text="City",font=("goudy old style",15,"bold"),bg="white").place(x=325,y=220)
        lbl_address=Label(self.root,text="Address",font=("goudy old style",15,"bold"),bg="white").place(x=10,y=260)
        
        #entry fields of column1
        ...
        txt_city=Entry(self.root,textvariable=self.var_city,font=("goudy old style",15,"bold"),bg="lightyellow").place(x=365,y=220,width=150)
        ...
        self.CourseTable.column("name",width=90)
        self.CourseTable.column("email",width=90)
        self.CourseTable.column("gender",width=60)
        self.CourseTable.column("dob",width=60)
        self.CourseTable.column("contact",width=80)
        self.CourseTable.column("admission",width=80)
        self.CourseTable.column("course",width=90)
        self.CourseTable.column("state",width=90)
        self.CourseTable.column("city",width=90)
